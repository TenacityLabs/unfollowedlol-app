        ...
        <div className= "flex-1 flex justify-center items-center">
            <div className="w-full h-[350px] flex flex-col gap-[32px] items-center ">
                <div className="flex flex-col gap-[4px] items-center">
                    <p className="max-w-[800px] text-wrap text-[52px] sm:text-[86px] text-center font-bold leading-[110%] bg-gradient-to-b from-[#FFFFFF] to-[#ffffff86] text-transparent bg-clip-text">Discover who's unfollowing you</p>
